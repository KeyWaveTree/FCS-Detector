...
#
#
# def landmark_img_position(origin_img_path)-> dict or int:
#     with mp_img_pose.Pose(
#     static_image_mode=True,
#     enable_segmentation=True,
#     min_detection_confidence=0.5) as pose:
#         copy_img=cv2.imread(origin_img_path)
#         try:
...
#
# img_path_map=image_path_map(Image_Data_Path)
#
#
# for img_path_key in img_path_map:
...
#
#       for img_path in img_path_map[img_path_key]:
#
...
#
#             else:
#               landmark_img = landmark_img_position(img_path)
#               edge_img=canny_edge_img(img_path)
#
#               setting_origin_img=origin_img[landmark_img['y1']:landmark_img['y2'], landmark_img['x1']:landmark_img['x2']]
#               setting_edge_img=edge_img[landmark_img['y1']:landmark_img['y2'], landmark_img['x1']:landmark_img['x2']]
#               try:
...
#                   str(len(img_path_map[img_path_key])) + '): ' + str(key_name))
#
#             # 처리한 이미지 저장
#             key_name += 1
#
